...
<section class="card chart-card"><div class="row-between"><div><p class="eyebrow">NAVAMSA KUNDALI</p><h2>Navamsa Chart (D9)</h2></div><span class="pill pill-success">Calculated from D1 degrees</span></div><?= renderNorthIndianChart($houses, $d9['lagna']) ?><p class="muted chart-note">Each Rashi sign is divided into nine 3°20′ Navamsas. D9 signs are calculated from the stored sidereal planetary longitudes.</p></section>
